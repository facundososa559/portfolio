  ...
  return (
    <section className='center-container d-flex flex-column align-items-center fs-2 fw-light'>
        <ul className='contact-container ps-0 m-0'>
          ...
          <li className='list-group-item'><a className='text-decoration-none text-black fs-2' href="https://www.instagram.com/facusosa.dev/" target='_blank' rel='noreferrer'>INSTAGRAM</a></li>
        </ul>
    </section>
  )
}
