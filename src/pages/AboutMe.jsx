...
function AboutMe() {
  return (
    <section className='about-container my-5 px-4'>
      ...
      <p className="about-paragraph">
        My goal is to assist companies and creative people in improving their online presence, specializing in Frontend technologies and AWS Cloud, making me a strong candidate for any project requiring these skills.
      </p>
      <p className='about-paragraph'>
