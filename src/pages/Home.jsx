        ...
        <section className='hero container--small container--flex container--center'>
            <div className='hero__container container--flex container--column text--align-center'>
              ...
              <AnimatedElement delay={0.3}>
                <p>Diseño, desarrollo y optimizo sitios web para que tus clientes reconozcan el valor de tus productos o servicios, en un lugar que brinda autoridad y presencia.</p>
              </AnimatedElement>
